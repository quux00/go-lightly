...
;; Note: this version was one of my early attempts to mimic Pike's
;; fake-google-search example using only Clojure, lamina and Java
;; (meaning nothings from the go-lightly library)
;; This is fairly rough code, exploring various options often
;; resulting in clunky stuff.
;; Leaving here for others to improve on - what is the best
;; way to do this only with lamina?
...
(defn get-google-fn [version]
  (case version
    :googlam1.0 google-1
    :googlam2.0f google-20f
    :googlam2.0c google-20c
    :googlam2.1 google-21
    :googlam3-alpha google-3-alpha
    :googlam3.0 google-3
    :googlam3.0b google-3b))
